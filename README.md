...
```
> [!NOTE]
> de enter para salvar a chave no direotiro padrão ./ssh <br/>
...
### Agora coloque um ID e uma descrição para indentificar sua chave.

> [!NOTE]
> O username que criamos se chama jenkins
